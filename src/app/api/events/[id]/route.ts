...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ message: 'Failed to delete event', error: error }, { status: 500 });
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json({ message: 'Failed to update event', error: error }, { status: 500 });
  }
}
