...
export const EVENT_LIST_ITEM = {
  ...
  UNKNOWN_STATUS_UPDATE_ERROR: '상태 업데이트 중 알 수 없는 오류가 발생했습니다.',
  DELETE_FAILURE: '일정 삭제에 실패했습니다.',
  DELETE_ERROR: '일정 삭제 중 오류 발생:',
  DELETE_ERROR_ALERT: (message: string) => `일정 삭제 중 오류가 발생했습니다: ${message}`,
  UNKNOWN_DELETE_ERROR: '일정 삭제 중 알 수 없는 오류가 발생했습니다.',
  CONFIRM_DELETE: (title: string) => `"${title}" 일정을 정말로 삭제하시겠습니까?`,
};
...
export const ADD_MODAL = {
  ...
  ADD_ERROR_ALERT: (message: string) => `일정 추가 중 오류가 발생했습니다: ${message}`,
...
export const EDIT_MODAL = {
  ...
  EDIT_ERROR_ALERT: (message: string) => `일정 수정 중 오류가 발생했습니다: ${message}`,
